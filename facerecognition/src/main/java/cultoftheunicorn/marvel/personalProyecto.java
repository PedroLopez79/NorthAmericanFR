...
public class personalProyecto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_personal_proyecto);
        ...
        personalProyecto.AsyncCallWS task = new personalProyecto.AsyncCallWS();
        task.execute();
        ...
        btnbuscar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(personalProyecto.this,  ListaEmpleados3.class);
    ...
    private class AsyncCallWS extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            adapter = new ArrayAdapter<String>(personalProyecto.this, R.layout.spinner_item2, listado);
